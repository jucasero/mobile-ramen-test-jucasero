const locale = {
  welcome_title: 'Conheça Mi Local',
  welcome_description:
    'O novo aplicativo para facilitar todas as suas tarefas.',
  ...
  gps_button: 'Ativar minha localização',
  ...
  notification_button: 'Ativar notificações',
};
