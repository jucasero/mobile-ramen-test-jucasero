const locale = {
  ...
  EMAIL_INFO: 'Lo necesitaremos para comunicarnos contigo.',
  EMAIL_VALIDATE_TITLE: 'Válida el ingreso con el código de seguridad',
  EMAIL_VALIDATE_INFO: 'Ingresa el código que te enviamos por correo.',
  ...
  EMAIL_VALIDATE_CODE_VALIDATION_MESSAGE: 'Válida el codigo de seguridad',
